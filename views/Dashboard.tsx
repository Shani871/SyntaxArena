                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-4 border-b border-white/5 mx-1">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-2 mb-1">
                                <span className="px-2 py-0.5 bg-blue-500/10 text-blue-400 text-[10px] font-bold rounded border border-blue-500/20 uppercase tracking-tighter">Level {MOCK_USER.level}</span>
                                <span className="px-2 py-0.5 bg-purple-500/10 text-purple-400 text-[10px] font-bold rounded border border-purple-500/20 uppercase tracking-tighter">{MOCK_USER.rank}</span>
                            </div>
                            <h2 className="text-3xl font-black text-white mb-1 tracking-tight">
                                GREETINGS, <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 uppercase">{user?.displayName || user?.email?.split('@')[0] || MOCK_USER.username}</span>.
                            </h2>
