            ...
            <div className="relative z-10 w-full max-w-md p-8 bg-[#1e1e1e]/90 backdrop-blur-xl border border-[#333] rounded-2xl shadow-2xl animate-fade-in mx-4 my-10">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="flex items-center justify-center gap-2 py-2.5 px-4 bg-[#252526] hover:bg-[#333] border border-[#333] rounded-lg text-white text-xs transition-colors group disabled:opacity-50"
                    >
